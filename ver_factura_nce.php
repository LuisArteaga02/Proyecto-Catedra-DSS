    ...
    <div class="doc">
        ...
        <div class="er-grid">
            ...
            <div class="emisor-block">
                ...
                <div class="er-body">
                    <div class="er-fila"><span class="lbl">Nombre o razón social:</span><span class="val"><?= htmlspecialchars($dte['emisor']['nombreComercial'] ?? $dte['emisor']['nombre']) ?></span></div>
                    ...
                    <div class="er-fila"><span class="lbl">Dirección:</span><span class="val"><?= htmlspecialchars($dte['emisor']['direccion']['complemento']) ?>, <?= htmlspecialchars($dte['emisor']['direccion']['municipio']) ?>, <?= htmlspecialchars($dte['emisor']['direccion']['departamento']) ?></span></div>
